...
import com.deshAndDez.commons.models.ErrorBody
...
inline fun <T> Flow<Response<EndPointResult<T>>>.transformResponseData(
        ...
        errorBody?.let { errorBody ->
            when (it.code()) {
                ...
                Constants.HttpRequestErrorCode.NOT_FOUND -> {
                    throw Throwable(Gson().toJson(ResponseErrorResult(
                        Constants.HttpRequestErrorCode.NOT_FOUND,
                        ErrorBody(
