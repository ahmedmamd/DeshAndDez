...
class ForgetPasswordResetFragment :
    BaseFragment(R.layout.fragment_forget_password_reset) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = FragmentForgetPasswordResetBinding.bind(requireView())
    ...
    private fun setupListeners() {
        ...
        binding.btnConfirm.setOnClickListener {
            findNavController().navigate(R.id.action_forgetPasswordResetFragment_to_homeFragment)
        }
    }
}